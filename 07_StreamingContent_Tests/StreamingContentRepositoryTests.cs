...
namespace _07_StreamingContent_Tests
{
    ...
    public class StreamingContentRepositoryTests
    {
        ...
        public void Arrange()
        {
            ...
            _content = new StreamingContent("Back to the Future", "A high school student gets sent back in time.", 4.4, GenreType.SciFi, MaturityRating.PG);
        ...
        {
            Movie joe = new Movie("Joe Dirt", "Dirty guy named joe eats dirt.", 3.4, GenreType.Comedy, MaturityRating.R, 112);
